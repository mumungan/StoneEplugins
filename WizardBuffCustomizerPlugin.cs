...
namespace Turbo.Plugins.Stone
{
    public class WizardBuffCustomizerPlugin : BasePlugin, ICustomizer
    {
        ...
        public void Customize()
        {
            ...
            Hud.GetPlugin<PlayerTopBuffListPlugin>().RuleCalculator.Rules.Add(new BuffRule(30796) { IconIndex = 2, MinimumIconCount = 1, ShowStacks = true, ShowTimeLeft = false }); // Wafe of Force
